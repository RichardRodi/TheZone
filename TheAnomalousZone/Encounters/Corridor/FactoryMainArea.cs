...
namespace TheAnomalousZone.Encounters.Corridor
{
    internal class FactoryMainArea : BaseEncounter
    {
        ...
        {
            {
                ...
                string prompt = ($"Navigating the main complex of the factory with cautious steps,\n" +
                    ...
                    $"a sudden realization dawns upon you—the jelly-like material exhibits a corrosive nature far beyond your initial expectations.\n" +
                ...
                {
                    case 0:
                        Console.WriteLine("You tread incredibly carefully as you make your way through the minefield of this sticky unknown substance");
                        Console.ReadKey(true);
                        break;

                    case 1:
                        Console.WriteLine("You make an incredible dash towards the unknown object");
                        Console.ReadKey();
                        if (_gameManager.SelectedMainPlayer.Speed == 13)
                        {
                            Console.WriteLine("With a burst of adrenaline-fueled agility,\n" +
                                ...
                                "as if they were extensions of your very being. Weapon Value + 5!\n");
                            Console.ReadKey();
                            Console.WriteLine("With nothing of value left in this area you move on.\n" +
                        ...
                        else Console.WriteLine("You awkwardly make your way through the sticky substance.\n" +
                        ...
                        break;
                    case 2:
                        Console.WriteLine("You have intention of being consumed alive by this horrific substance so decide to move on.\n" +
                            "You exit the factory facility and continue down the main road.");
                        Console.ReadKey(true);
                        NextEncounter(typeof(MainRoadContinued));
                        break;
        ...
        private void SubstanceMaze()
        {
            ...
            string prompt = ($"You are confronted with a few choices as you approach the maze of corrosive substances that dot the floor leading up to the prized object.\n\n");

            string[] options = { "1.Take the left path which has fewer pools of substance on the floor but is longer.", "2. Take the right path which has more pools of the substance on the floor but is shorter.", "3.Head Back", $"4.Use a FirstAid Kit. Player's Health: {_gameManager.SelectedMainPlayer.Health}/{_gameManager.SelectedMainPlayer.MaxHealth}", "5.Check Player Stats." };
            BaseMenu menu = new BaseMenu(prompt, options);
            int selectedIndex = menu.Run();
            ...
            {
                case 0:
                    Console.WriteLine("Choosing the left path, where the pools of corrosive substance are fewer but the journey is longer,\n" +
                    ...
                    DeathCheck.IsALive(_gameManager.SelectedMainPlayer);
                    Console.ReadKey();
                    Console.WriteLine("Reaching the coveted object, a surge of euphoria washes over you,\n" +
                        "flooding your senses with an unparalleled sense of empowerment.\n" +
                        "As if touched by some mysterious force, you feel invigorated,\n" +
                        "as though you can conquer any challenge that lies ahead.\n" +
                        "Your focus sharpens to a razor's edge, and you find yourself wielding your weapons with newfound expertise,\n" +
                        "as if they were extensions of your very being. Weapon Value + 5!");
                    Console.ReadKey();
                    Console.WriteLine("With nothing of value left in this area you carefully retrace your steps and move on.\n" +
                        "You exit the factory facility and continue down the main road.");
                    _gameManager.SelectedMainPlayer.WeaponValue += 5;
                    Console.ReadKey(true);
                    NextEncounter(typeof(MainRoadContinued));
                ...
                case 1:
                    Console.WriteLine("Opting for the right path, where the density of pools containing the unknown substance is higher,\n" +
                        ...
                        "A splash of it surges upward, searing through your pant legs with an intensity that sends waves of agony coursing through your body.");
                    ...
                    break;
                case 2:
                    Console.WriteLine("Taking a moment to reassess your options, you decide to backtrack to the main area of the factory.");
                    Console.ReadKey(true);
                    RunEncounter();
                    break;
                case 3:
